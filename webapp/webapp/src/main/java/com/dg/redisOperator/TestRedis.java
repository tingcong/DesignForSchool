...
public class TestRedis {
    ...
    public void setup(){
        //连接redis服务器
        jedis=new Jedis("10.10.23.152",3679);
...
//        jedis.auth("redis");
    ...
    public void testString(){
        ...
        //设置多个键值对
        jedis.mset("name","lijia","age","21","sex","female");
        //进行加1操作
        jedis.incr("age");
    ...
    public void testSet(){
        //添加
        jedis.sadd("user","lijia");
        jedis.sadd("user","guoxiaqin");
        jedis.sadd("user","chengyan");
        jedis.sadd("user","guoxiaqin");
        jedis.sadd("user","lijia");
